...
###  by Brent Coull                          ###
###  8/22/18                                 ###
###  Simpler generates plots w/o tidyverse   ###
###  Last updated by BC: 8/13/2021           ###
################################################
...
sel<-seq(12501,25000,by=50)#throw out the first 5000 samples because 
#start arbitrarily where you are and it will take a bunch of 
#iterations before you reach the actual distribution; stochastic process, 
#take every 10th or 50th sample because highly correlated
...
# Remove fit because it takes A LOT of RAM
rm(fit_gvs_knots100)
rm(modeltoplot)
