...
We can calculate the mean squared error (MSE) of the tree result. 
...
roc_gbm <- roc(data_test$log_telomean, preds_gbm_1)
plot(roc_gbm, legacy.axes = TRUE, print.auc = TRUE)
```
