...
varImpPlot(bag_telo, main = "Bagging Important Variables")
...
# Remove confounders
bag_imp_df <- bag_imp_df[-c(25, 26, 27, 28, 30, 31), ] 

# Plot the important chemicals
bag_imp_df %>% 
  ggplot(aes(x = reorder(feature, IncNodePurity), 
                         y = IncNodePurity)) +
  geom_point() +
  coord_flip() +
  theme_classic() +
...
# Quickly plot variable importance 
varImpPlot(fit_rf, main = "Random Forest Important Variables")
...
# Remove confounders
rf_imp_df <- rf_imp_df[-c(25, 26, 27, 28, 30, 31), ] 
