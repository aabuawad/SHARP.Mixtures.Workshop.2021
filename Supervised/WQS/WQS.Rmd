...
author: "Chris Gennings, Stefano Renzetti and Yanelli Nunez"
date: "8/16/2019"
output: 
  html_document:
    toc: TRUE
...
#install.packages('gWQS', update.packages(checkBuilt = TRUE))
#install.packages("gWQS", type = "source")
...
mixture = c("LBX074LA", "LBX099LA", "LBX118LA", "LBX138LA", "LBX153LA", "LBX170LA", "LBX180LA",
            "LBX187LA","LBX194LA", "LBXD03LA", "LBXD05LA", "LBXD07LA", "LBXF03LA", "LBXF04LA", 
            "LBXF05LA", "LBXF08LA", "LBXHXCLA", "LBXPCBLA")
...
results1 = gwqs(log_TELOMEAN ~ wqs, 
                mix_name = mixture, 
                data = dataset, 
                q = 10, 
                validation = 0.6,
...
### Adjusted & Negative Constrained Model
...
result4 = gwqs(log_TELOMEAN ~ wqs +
                 ...
                 ln_lbxcot + 
                 edu_cat, 
                mix_name = mixture_new, data = dataset_new, 
               q = 10, validation = 0.6,  b = 100, 
               b1_pos = TRUE, b1_constr = FALSE, 
               family = "gaussian", 
               seed = 123, plots = TRUE, tables = FALSE)
